#!/usr/bin/env python3
"""
Quick network test without sleep delays
"""
...
def test_networking():
    ...
    exit_code, stdout, stderr = attacker.execute_command('hostname')
    print(stdout)
    ...
    # Test 5: Check process list on target
    print('=== Test 5: Target system processes ===')
    target.login('root', 'root')
    exit_code, stdout, stderr = target.execute_command('ps')
    print(stdout)
