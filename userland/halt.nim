...
proc main() =
  print(cast[ptr uint8]("halt: syncing filesystems...\n"))
  ...
  print(cast[ptr uint8]("halt: halting system now...\n"))
  ...
  print_err(cast[ptr uint8]("halt: failed to halt system\n"))
  print_err(cast[ptr uint8]("halt: you may need root privileges\n"))
