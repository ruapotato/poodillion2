...
section .data
str_0: db "Brainhair Text Editor v0.1", 10, "", 0
str_1: db "/dev/fb0", 0
...
str_9: db "New file: ", 0
str_10: db "", 10, "", 0
str_11: db "No filename - use Ctrl+S to save", 10, "", 0
str_12: db "[untitled]", 0
str_13: db "[modified]", 0
str_14: db "Saved: ", 0
str_15: db "", 10, "", 0
str_16: db "Editor closed", 10, "", 0
