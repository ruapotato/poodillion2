...
section .data
str_0: db "Brainhair File Manager v0.1", 10, "", 0
str_1: db "/dev/fb0", 0
str_2: db "Error: Cannot open /dev/fb0", 10, "", 0
str_3: db "/dev/input/mice", 0
str_4: db "Error: Cannot open mouse", 10, "", 0
str_5: db "Screen: ", 0
str_6: db "x", 0
str_7: db "", 10, "", 0
str_8: db ".", 0
str_9: db "Entries: ", 0
str_10: db "", 10, "", 0
str_11: db "File Manager", 0
str_12: db ".", 0
str_13: db "File Manager closed", 10, "", 0
...
while_end891:
    mov eax, [ebp-4]
    jmp read_directory_return
read_directory_return:
    mov esp, ebp
    pop ebp
    ret
...
get_entry_type:
    ...
    add eax, ebx
    movzx eax, byte [eax]
    jmp get_entry_type_return
get_entry_type_return:
    mov esp, ebp
    pop ebp
    ret
...
get_entry_name:
    ...
    pop eax
    add eax, ebx
    jmp get_entry_name_return
get_entry_name_return:
    mov esp, ebp
    pop ebp
    ret
